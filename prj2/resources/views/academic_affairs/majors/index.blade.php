...
@section('content')
    ...
    <div class="modal fade" id="staticBackdrop2" data-coreui-backdrop="static" data-coreui-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Cập nhật chuyên ngành</h5>
                    <button type="button" class="btn-close" data-coreui-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('aa-major-update') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <input name="major_id" hidden value="{{ $major->major_id }}">
                        <input class="form-control" name="major_name" placeholder="Tên chuyên ngành" value="{{ $major->major_name }}" autocomplete="off">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-coreui-dismiss="modal">Đóng</button>
                        <button type="submit" class="btn btn-primary">Xác nhận</button>
